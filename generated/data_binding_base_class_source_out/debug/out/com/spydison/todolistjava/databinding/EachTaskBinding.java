...
public final class EachTaskBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView taskDiscrip;

  @NonNull
  public final TextView taskTitle;

  private EachTaskBinding(@NonNull ConstraintLayout rootView, @NonNull TextView taskDiscrip,
  ...
  public static EachTaskBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.task_discrip;
      TextView taskDiscrip = ViewBindings.findChildViewById(rootView, id);
      if (taskDiscrip == null) {
        break missingId;
      }
      ...
      return new EachTaskBinding((ConstraintLayout) rootView, taskDiscrip, taskTitle);
    }
